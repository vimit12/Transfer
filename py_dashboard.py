                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                ...
                                value=month_order[0],  # January as default
                                clearable=False,
                                style={"width": "150px"}
                            ),
                        ], style={"display": "inline-block", "marginRight": "24px"}),
...
def update_consolidated_table(selected_year, selected_month, threshold):
    ...
    table = html.Table([
        html.Thead([
            html.Tr([
                html.Th("Full Name", style={"border": "1px solid black", "padding": "8px", "backgroundColor": "#f2f2f2", "textAlign": "center"}),
                html.Th("Leave Taken Days", style={"border": "1px solid black", "padding": "8px", "backgroundColor": "#f2f2f2", "textAlign": "center"}),
                html.Th("Total Working Days", style={"border": "1px solid black", "padding": "8px", "backgroundColor": "#f2f2f2", "textAlign": "center"}),
                html.Th("Attendance %", style={"border": "1px solid black", "padding": "8px", "backgroundColor": "#f2f2f2", "textAlign": "center"}),
            ])
        ]),
        html.Tbody([
            html.Tr([
                html.Td(row["Full Name"], style={"border": "1px solid black", "padding": "8px", "textAlign": "center"}),
                html.Td(row["Leave Taken Days"], style={"border": "1px solid black", "padding": "8px", "textAlign": "center"}),
                html.Td(row["Total Working Days"], style={"border": "1px solid black", "padding": "8px", "textAlign": "center"}),
                html.Td(f"{row['Attendance %']:.1f}%",
                        style={
                            "border": "1px solid black",
                            "padding": "8px",
                            "textAlign": "center",
                            "color": "red" if row["Attendance %"] < threshold else "green",
                            "fontWeight": "700"
                        }),
