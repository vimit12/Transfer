...
"""
Hitachi DS
Working days - mon - fri(for Jan 23) including holiday
Billable Days - (cal) number of (8 or 4)
Leaves Taken - Only Leave day
text to number for leave taken etc
Neha Shridhar Gundkal - Billable day - wd(exclude holiday, leave)
Summary not required
Name	Jan Leave Taken	Year End Leave
Anburaj	0	
